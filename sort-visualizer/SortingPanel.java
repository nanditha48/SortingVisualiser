...
public class SortingPanel extends JPanel {
    ...
    public SortingPanel() {
        ...
        reset.setFont(new Font("Arial", Font.BOLD, 14)); // Set font to bold
        reset.setForeground(Color.WHITE); // Set text color to white
        reset.setBackground(Color.BLACK); // Set background color to black
   ...
   @Override
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (g.getColor() != Color.YELLOW && g.getColor() != Color.PINK
                    && g.getColor() != Color.BLUE && g.getColor() != Color.RED)
